...
void ST7789_nRF::drawFastVLine(int16_t x, int16_t y, int16_t h,
                                uint16_t color) {
...
void ST7789_nRF::drawFastHLine(int16_t x, int16_t y, int16_t w,
                                uint16_t color) {
  if ((x >= _width) || (y >= _height)) return;
...
void ST7789_nRF::fillRect(int16_t x, int16_t y, int16_t w, int16_t h,
                           uint16_t color) {
  if ((x >= _width) || (y >= _height)) return;
  if ((x + w - 1) >= _width)  w = _width  - x;
  if ((y + h - 1) >= _height) h = _height - y;
