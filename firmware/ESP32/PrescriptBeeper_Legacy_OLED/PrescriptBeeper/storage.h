          ...
          if (c6 != -1) {
            ...
            if (c7 != -1) {
              ...
              if (c8 != -1) {
                ...
                timerFormatLong = content.substring(c8 + 1).toInt() != 0;
              } else {
...
void writeSettings() {
  ...
  if (f) {
    f.println(String(textScale) + "," + String(scrambleDurationFrames) + "," + String(scrambleDelayMs) + "," + String(revealDelayMs) + "," + String(timerPosition) + "," + String(timerScale, 2) + "," + String(bleRequirePin ? 1 : 0) + "," + String(useProportionalFont ? 1 : 0) + "," + String(timerFormatLong ? 1 : 0));
    f.close();
  }
}
...
void sendSettings() {
  ...
  String msg = "RES:SETTINGS|MSG:" + String(textScale) + "," + String(scrambleDurationFrames) + "," + String(scrambleDelayMs) + "," + String(revealDelayMs) + "," + String(timerPosition) + "," + String(timerScale, 2) + "," + String(bleRequirePin ? 1 : 0) + "," + String(useProportionalFont ? 1 : 0) + "," + String(timerFormatLong ? 1 : 0) + "\n";
